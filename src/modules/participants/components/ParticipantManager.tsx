      ...
      {gameState.participants.length > 0 ? (
        <ul className="space-y-2">
          {gameState.participants.map((participant) => (
            ...
            >
              <span className="font-medium text-purple-800 dark:text-purple-300">{participant.name}</span>
              <button
        ...
        <p className="text-center text-gray-500 dark:text-gray-400">Thêm người chơi để bắt đầu trò chơi</p>
      )}
